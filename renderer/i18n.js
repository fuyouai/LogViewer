...
(function() {
  ...
  var messages = {
    en: {
      ...
      'sidebar.selectAll': 'Check all',
      'sidebar.showAll': 'Reset filter',
      'sidebar.processes': 'Processes ({n})',
      'sidebar.filterProcesses': 'Filter processes...',
      'sidebar.noMatchingProcesses': 'No matching processes',
      'sidebar.expandThreads': 'Show threads',
      'sidebar.collapseThreads': 'Hide threads',
      'sidebar.expandThreadsHint': 'Check the process first to expand threads',
    ...
    zh: {
      ...
      'sidebar.selectAll': '勾选全部',
      'sidebar.showAll': '重置过滤',
      'sidebar.processes': '进程 ({n})',
      'sidebar.filterProcesses': '筛选进程...',
      'sidebar.noMatchingProcesses': '没有匹配的进程',
      'sidebar.expandThreads': '展开线程',
      'sidebar.collapseThreads': '收起线程',
      'sidebar.expandThreadsHint': '请先勾选该进程后再展开线程',
